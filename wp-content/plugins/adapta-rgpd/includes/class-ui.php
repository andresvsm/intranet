				...
				<table class="wp-list-table widefat fixed striped posts">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<p class="description">
									<b>¡Nuevo!</b> Página que permite al usuario configurar sus preferencias en relación con las cookies.
								</p>
							</td>
						</tr>			
					</tbody>
								...
								<td>
									...
									<label  for="cookies-fixed">
										<input 	name="cookies-fixed" 
												...
												>
												<?php esc_html_e( 'Activa un botón flotante para mostrar el Banner de Cookies cuando está cerrado.', 'argpd' ); ?> 
												<br/>
												<p class="description">
													<?php esc_html_e( 'Recomendado.', 'argpd' ); ?>
												</p>
